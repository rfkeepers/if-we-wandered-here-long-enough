...
- Pull knowledge from tomes and musty memory.
- Assert through winded, rambling proof.
- Discern nearby magic through your senses.
- Pressure someone in an orderly, neat, and respectful manner.
- Reconfigure a natural law to assert new truth.
- Obsess over a complex or arcane system.
...
- Expert: _Focus, Bend_
- Master: _Swallow, Radiate_

**Spatia** (_Space_, _Sound_)
- Adept: _Deny passage to..., Shield against..._
- Expert: _Connect_
- Master: _Collapse_

**Materia** (_Inanimate Materials_)
- Adept: _Weaken, Harden_
- Expert: _Mend_
- Master: _Transmute_

**Notitia** (_Knowledge, Information_)
- Adept: _View, Detect_
- Expert: _Separate_
- Master: _Erase_

**Vires Elementia** (_Elemental Energies_)
- Adept: _Quench, Fuel_
- Expert: _Sculpt_
- Master: _Detonate_
...
On a Hit, you cast the spell, more or less like you intended.

2+: Choose one from below.
1: Choose two.

- Something goes awry; the MC will add an “and” or “but” to its effect.
- You're unable to manipulate or disperse the effect afterward.
...
If at least one die matches: the spell is warped, surprising, or tumultuous.  The MC makes a move.
...
Select one of your _axioms_ and one of your _virtues_; tell them to the MC, then explain this new epiphany, and how those things fit into it.  The MC will explain how the world around you reshapes itself to those new truths.
